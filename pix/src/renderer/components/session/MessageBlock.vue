 ...
 *
 * Shows user input as a document-flow block (left-aligned, no chat bubble),
 * per gui.md §12.1 / §6.2 (no left/right bubbles, no avatars).
 */
import { ref } from "vue";
...
.message-content {
  max-width: var(--pix-content-max-width, 760px);

    ...
    <div class="settings-layout">
      ...
      <div class="settings-content">
        ...
        <div v-show="activeSection === 'auth'" class="section-panel">
          ...
          <p class="section-desc">配置各模型提供商的 API 密钥。密钥存储在 <code>~/.pp/agent/auth.json</code>。</p>
        ...
        <div v-show="activeSection === 'advanced'" class="section-panel">
          ...
          <div class="form-fields">
            ...
            <div class="advanced-info">
              ...
              <div class="info-row"><span>数据目录</span><code>~/.pp/agent/</code></div>
              <div class="info-row"><span>会话存储</span><code>~/.pp/agent/sessions/</code></div>
              <div class="info-row"><span>设置文件</span><code>~/.pp/agent/settings.json</code></div>
            </div>
          </div>
        </div>

...
/**
 * Migrate sessions from ~/.pp/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.pp/agent/ instead of
 * ~/.pp/agent/sessions/<encoded-cwd>/. This migration moves them

...
// ============================================================================
// OAuth API key resolution from ~/.pp/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".pp", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.pp/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.pp/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".pp", "agent");

/**
 * Get an AuthStorage instance backed by ~/.pp/agent/auth.json

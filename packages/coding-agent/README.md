...
**Custom providers & models:** Add providers via `~/.pp/agent/models.json` if they speak a supported API (OpenAI, Anthropic, Google). For custom APIs or OAuth, use extensions. See [docs/models.md](docs/models.md) and [docs/custom-provider.md](docs/custom-provider.md).
...
See `/hotkeys` for the full list. Customize via `~/.pp/agent/keybindings.json`. See [docs/keybindings.md](docs/keybindings.md).
...
Sessions auto-save to `~/.pp/agent/sessions/` organized by working directory.
...
| Location | Scope |
|----------|-------|
| `~/.pp/agent/settings.json` | Global (all projects) |
| `.pp/settings.json` | Project (overrides global) |
...
Replace the default system prompt with `.pp/SYSTEM.md` (project) or `~/.pp/agent/SYSTEM.md` (global). Append without replacing via `APPEND_SYSTEM.md`.
...
```markdown
<!-- ~/.pp/agent/prompts/review.md -->
Review this code for bugs, security issues, and performance problems.
Focus on: {{focus}}
```

Place in `~/.pp/agent/prompts/`, `.pp/prompts/`, or a [pi package](#pi-packages) to share with others. See [docs/prompt-templates.md](docs/prompt-templates.md).
...
```markdown
<!-- ~/.pp/agent/skills/my-skill/SKILL.md -->
# My Skill
...
Place in `~/.pp/agent/skills/`, `~/.agents/skills/`, `.pp/skills/`, or `.agents/skills/` (from `cwd` up through parent directories) or a [pi package](#pi-packages) to share with others. See [docs/skills.md](docs/skills.md).
...
Place in `~/.pp/agent/extensions/`, `.pp/extensions/`, or a [pi package](#pi-packages) to share with others. See [docs/extensions.md](docs/extensions.md) and [examples/extensions/](examples/extensions/).

### Themes

Built-in: `dark`, `light`. Themes hot-reload: modify the active theme file and pi immediately applies changes.

Place in `~/.pp/agent/themes/`, `.pp/themes/`, or a [pi package](#pi-packages) to share with others. See [docs/themes.md](docs/themes.md).
...
|----------|-------------|
| `PI_CODING_AGENT_DIR` | Override config directory (default: `~/.pp/agent`) |

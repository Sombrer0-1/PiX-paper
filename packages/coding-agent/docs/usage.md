...
Sessions are saved automatically to `~/.pp/agent/sessions/`, organized by working directory.
...
- `~/.pp/agent/AGENTS.md` for global instructions
...
- `.pp/SYSTEM.md` for a project
- `~/.pp/agent/SYSTEM.md` globally
...
|----------|-------------|
| `PI_CODING_AGENT_DIR` | Override config directory; default is `~/.pp/agent` |
